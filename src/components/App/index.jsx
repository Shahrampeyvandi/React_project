...
class App extends React.Component {
  ...
  setAuthUser = (authUser) => {
    this.setState({
      ...
      this.props.noty.success('successfuly Loged In')   //--------   noty after Login or Signup
  ...
  removeUser = () => {
    ...
    this.setState({authUser:null})  //---remove User from state after Logout
    this.props.history.push('/');
  }
